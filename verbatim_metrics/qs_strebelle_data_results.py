...
from verbatim_metrics.data import df_full, get_simulation_maps_n, get_simulation_maps
...
df = pd.concat([pd.DataFrame({'value': vm_result, 'type': 'verbatim'}),
                pd.DataFrame({'value': cl_result, 'type': 'cluster'}),
